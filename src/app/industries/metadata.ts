...
export const metadata: Metadata = {
  title: "Industries - Blockchain Solutions for Every Sector | HyperFabrics",
  description:
    "HyperFabrics serves 9 key industries with enterprise-grade blockchain infrastructure: Central Banks, Financial Services, Government, Healthcare, Insurance, Supply Chain, Gaming, Media, and ESG. Compliant, scalable, and secure.",
  keywords: [
...
export const pageContent = {
  ...
  description:
    "HyperFabrics delivers enterprise-grade blockchain infrastructure designed specifically for industries that demand security, compliance, and operational excellence. From central banks deploying CBDCs to healthcare organizations managing patient records, our platform provides the production-ready foundation for digital transformation across 9 key sectors worldwide.",
  quickLinks: [
    {
